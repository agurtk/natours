...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiYW1pZzg4IiwiYSI6ImNsdXBuaGl3ZTF0aDAyanA3ZnF5MnczMDIifQ.pLHao5p2v_FOMp-G_uZS2g";
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    var updatePasswordUrl, updateMeUrl, url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          updatePasswordUrl = "http://127.0.0.1:3001/api/v1/users/updateMyPassword";
          updateMeUrl = "http://127.0.0.1:3001/api/v1/users/updateMe";
          url = type === "password" ? updatePasswordUrl : updateMeUrl;
          _context.next = 6;
          return (0, _axios.default)({
            method: "PATCH",
            url: url,
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _stripeJs.loadStripe)("pk_test_51P6tpQCYFQRE4Rg5qFwyRnJpke31sd45VogMBNSOWa7cXyplWVWyRa60tbjdLuwSg5XGTbQtSe80BsqtBnw3gb9E00lIVEuc2E");
        case 2:
...
if (loginForm) console.log("login form");
